<?php
add_action( 'vc_before_init', 'dtlms_student_assigned_items_list_vc_map' );

function dtlms_student_assigned_items_list_vc_map() {
	...
	vc_map( array(
		"name"        => esc_html__( 'Student Assigned Items List', 'dtlms-lite' ),
		"base"        => "dtlms_student_assigned_items_list",
		"icon"        => "dtlms_student_assigned_items_list",
		"category"    => DTLMS_PB_MODULE_DASHBOARD_TITLE,
		'description' => esc_html__('To display student assigned items list.', 'dtlms-lite'),
		"params"      => array(
