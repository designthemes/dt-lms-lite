...
class DTLMSDbStudentUnderevaluationItems extends Widget_Base {
	...
	public function get_name() {
		return 'dtlms-widget-dashboard-student-underevaluation-items';
	}

	public function get_title() {
		return esc_html__( 'Student Under Evaluation Items', 'dtlms-lite' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section( 'default-dashboard-student-underevaluation-items-section', array(
	...
	protected function render() {
		...
		$output     = do_shortcode('[dtlms_student_underevaluation_items '.$attributes.' /]');
		echo $output;
    }
}