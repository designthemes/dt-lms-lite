...
class DTLMSDbStudentAssignedItems extends Widget_Base {
	...
	public function get_name() {
		return 'dtlms-widget-dashboard-student-assigned-items';
	}

	public function get_title() {
		return esc_html__( 'Student Assigned Items', 'dtlms-lite' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section( 'default-dashboard-student-assigned-items-section', array(
	...
	protected function render() {
		...
		$output     = do_shortcode('[dtlms_student_assigned_items '.$attributes.' /]');
		echo $output;
