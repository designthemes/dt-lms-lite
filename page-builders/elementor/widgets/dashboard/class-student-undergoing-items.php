...
class DTLMSDbStudentUndergoingItems extends Widget_Base {
	...
	public function get_name() {
		return 'dtlms-widget-dashboard-student-undergoing-items';
	}

	public function get_title() {
		return esc_html__( 'Student Undergoing Items', 'dtlms-lite' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section( 'default-dashboard-student-undergoing-items-section', array(
	...
	protected function render() {
		...
		$output     = do_shortcode('[dtlms_student_undergoing_items '.$attributes.' /]');
		echo $output;
    }
}