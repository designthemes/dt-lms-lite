...
class DTLMSDbStudentCompletedItemsList extends Widget_Base {
	...
	public function get_name() {
		return 'dtlms-widget-dashboard-student-completed-items-list';
	}

	public function get_title() {
		return esc_html__( 'Student Completed Items List', 'dtlms-lite' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section( 'default-dashboard-student-completed-items-list-section', array(
	...
	protected function render() {
		...
		$output     = do_shortcode('[dtlms_student_completed_items_list '.$attributes.' /]');
		echo $output;
    }
}