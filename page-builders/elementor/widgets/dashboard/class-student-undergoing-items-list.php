...
class DTLMSDbStudentUndergoingItemsList extends Widget_Base {
	...
	public function get_name() {
		return 'dtlms-widget-dashboard-student-undergoing-items-list';
	}

	public function get_title() {
		return esc_html__( 'Student Undergoing Items List', 'dtlms-lite' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section( 'default-dashboard-student-undergoing-items-list-section', array(
			...
			$this->add_control( 'item-type', array(
				...
				'description' => esc_html__( 'Choose item type to display its undergoing list.', 'dtlms-lite' ),
				'default'     => '',
			) );
	...
	protected function render() {
		...
		$output     = do_shortcode('[dtlms_student_undergoing_items_list '.$attributes.' /]');
		echo $output;
    }
}