...
class DTLMSDbStudentAssignedItemsList extends Widget_Base {
	...
	public function get_name() {
		return 'dtlms-widget-dashboard-student-assigned-items-list';
	}

	public function get_title() {
		return esc_html__( 'Student Assigned Items List', 'dtlms-lite' );
	}
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section( 'default-dashboard-student-assigned-items-list-section', array(
	...
	protected function render() {
		...
		$output     = do_shortcode('[dtlms_student_assigned_items_list '.$attributes.' /]');
		echo $output;
    }
}