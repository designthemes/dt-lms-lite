var dtLMSFrontendUtils = {
	...
	dtLMSToggleItems : function() {
		...
		if(jQuery('.dtlms-toggle').length) {
			...
			jQuery('.dtlms-toggle').click(function(){
...
var dtLMSFrontend = {
	...
	dtCourses : function() {
		...
		jQuery('.dtlms-class-toggle-switch').click(function(){ jQuery(this).parents('.dtlms-class-toggle-frame').find('.dtlms-class-toggle-content').slideToggle(); });
